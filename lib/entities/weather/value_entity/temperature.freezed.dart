...
abstract class $TemperatureCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'min') double minTemperature,
      @JsonKey(name: 'max') double maxTemperature});
}
...
class _$_Temperature implements _Temperature {
  const _$_Temperature(
      {@JsonKey(name: 'min') required this.minTemperature,
      @JsonKey(name: 'max') required this.maxTemperature});
...
abstract class _Temperature implements Temperature {
  const factory _Temperature(
          {@JsonKey(name: 'min') required final double minTemperature,
          @JsonKey(name: 'max') required final double maxTemperature}) =
      _$_Temperature;
