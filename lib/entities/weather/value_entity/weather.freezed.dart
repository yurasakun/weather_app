...
/// @nodoc
mixin _$Weather {
  @JsonKey(name: 'main', fromJson: types)
...
abstract class $WeatherCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'main', fromJson: types) TypeWeather type});
}
...
class _$_Weather implements _Weather {
  const _$_Weather(
      {@JsonKey(name: 'main', fromJson: types) required this.type});
...
abstract class _Weather implements Weather {
  const factory _Weather(
      {@JsonKey(name: 'main', fromJson: types)
      required final TypeWeather type}) = _$_Weather;
